...
### Step 2: Connect Truffle to a Proxy
...
As a concrete example, to deploy contracts using the **neonlabs** network, described [earlier](using_truffle#truffle-configjs):
```sh
