...
Save the above content in postgres/docker-compose.yml.

##### How to Run it in Bash
```bash
docker-compose -f postgres/docker-compose.yml up -d --quiet-pull
```
...
```
#### Step 3: Run the Indexer Service
...
Save the above content in indexer/docker-compose.yml.

##### How to Run it in Bash
```bash
docker-compose -f indexer/docker-compose.yml up -d --quiet-pull
```
The output should look like this:
```console
...
Save the above content in proxy/docker-compose.yml.

##### How to Run it in Bash
```bash
docker-compose -f proxy/docker-compose.yml up -d --quiet-pull
```
The output should look like this:
```console
Creating proxy ... done
