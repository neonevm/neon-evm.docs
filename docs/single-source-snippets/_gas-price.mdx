...
> (1 + Proxy Operator fee + Proxy gas price slippage ) \* SOL-to-NEON-rate \* 10<sup>-9</sup> NEONs

which can also be represented as:

> (1 + Proxy Operator fee + Proxy gas price slippage ) \* SOL-to-NEON-rate Galans
...
> = [ N \* 2 \* 5,000 + S \* 6,960 ] \* (1 + Proxy Operator fee + Proxy gas price slippage ) \* SOL-to-NEON-rate