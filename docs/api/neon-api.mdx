...
<!-- useful for testing my example issue <JSONSchemaViewer schema={ neon_proxyVersion_response } /> -->
...
- `neon_evmVersion` returns the current version of the Neon EVM program deployed on the Solana
