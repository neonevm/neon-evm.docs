...
returns a list of components provided by the current Neon Platform
...
returns transaction log data

#### Get transaction receipt 

`neon_getTransactionReceipt`

returns transaction receipt data

#### Get Solana transactions 

`neon_getSolanaTransactionByNeonTransaction`

returns a list of Solana transactions that correspond to a given Neon transaction

#### Emulate a Neon transaction 

`neon_emulate`

returns details of an emultated transaction
