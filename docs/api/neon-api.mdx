...
Select the tab that applies according to whether you wish to retrieve all the version data or granular information.
...
The `neon_versions` method returns a list of all the components and their version as provided by the current Neon Platform.
