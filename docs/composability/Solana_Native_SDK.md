...
const proxyApi = new NeonProxyRpcApi('https://proxy.devnet.neonevm.org');
```
...
```
REACT_APP_SOLANA_URL=https://api.devnet.neonevm.org
REACT_APP_NEON_CORE_API_RPC_URL=https://proxy.devnet.neonevm.org
