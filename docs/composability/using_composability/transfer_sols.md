...
3. [TransferSOLsBetweenAccounts.js](https://github.com/neonlabsorg/neon-tutorials/blob/add/call-solana/hardhat/scripts/TestCallSolana/TransferSOLsBetweenAccounts.js) - This script is designed to demonstrate the creation of two accounts (SenderAccount and ReceiverAccount) on the Solana blockchain and perform a couple of SOL transfer transactions involving these accounts.
