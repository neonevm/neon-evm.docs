...
**Step 4.** Access an [Ethereum node](https://ethereum.org/en/developers/docs/nodes-and-clients/), either by running your own, connecting to a public node, or via an API key using a service like Infura or Alchemy
...
**Step 3.** Navigate to the compile icon on the left-hand side and click `Compile`.  
...
**Step 5.** Click `Deploy`. Your contract will appear at the bottom.  
